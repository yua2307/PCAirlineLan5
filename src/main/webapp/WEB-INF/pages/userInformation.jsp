                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <mvc:form action="updateInformation" method="POST" id="fileForm" role="form" modelAttribute="customer">
                                            <fieldset><legend class="text-center">Valid information is required to update information. <span class="req"><small> required *</small></span></legend>
                                                <div class="form-group">
                                                    <label for="username"><span class="req">* </span> Username:  <small>This is your login user name</small> <p style="color: red;">${exist}</p></label> 
                                                        <mvc:input readonly="true" value="${customer.getUsername()}" name="usernamee" onchange="checkUsername()" path="username" minlength="6" maxlength="16" class="form-control" type="text" id = "username" placeholder="minimum 6 letters"  required="required" />  
                                                    <div id="errLast"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="phonenumber"><span class="req">* </span> Phone Number: </label>
                                                    <mvc:input value="${customer.getPhoneNumber()}" required="required" path="phoneNumber" type="text" name="phonenumber" id="phone" class="form-control phone" maxlength="28" onkeyup="validatephone(this);" placeholder="not used for marketing"/> 
                                                </div>

                                                <div class="form-group"> 	 
                                                    <label for="firstname"><span class="req">* </span> Full name: </label>
                                                    <mvc:input value="${customer.getName()}" path="name" class="form-control" type="text" name="firstname" id = "txt"  required="required" /> 
                                                    <div id="errFirst"></div>    
                                                </div>

                                                <div class="form-group">
                                                    <label for="phonenumber"><span class="req">* </span> Identify Number: </label>
                                                    <mvc:input value="${customer.getIdentifyNumber()}" path="identifyNumber" required="required" type="text" class="form-control phone" maxlength="28" onkeyup="validatephone(this);" /> 
                                                </div>

                                                <div class="form-group">
                                                    <label for="email"><span class="req">* </span> Email Address: </label> 
                                                    <mvc:input value="${customer.getEmail()}" path="email" required="required" class="form-control" type="text" name="email" id = "email"  onchange="email_validate(this.value);" />   
                                                    <div class="status" id="status"></div>
                                                </div>
                                                <div class="form-group"> 	 
                                                    <label for="firstname"><span class="req">* </span> Address: </label>
                                                    <mvc:input value="${customer.getAddress()}" path="address" class="form-control" type="text" name="firstname" id = "txt" required="required" /> 
                                                    <div id="errFirst"></div>    
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <mvc:button class="btn btn-success" type="submit" name="submit_reg">Update</mvc:button>
                                                    <a href="<c:url value="/changePassword" />" class="btn btn-secondary">Change password</a>
                                                </div>
                                            </fieldset>
