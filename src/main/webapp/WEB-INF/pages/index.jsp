                        ...
                        <div class="container">
                            <div class="row fullscreen align-items-center justify-content-between">
                                <div class="col-lg-6 col-md-6 banner-left">
                                    ...
                                    <a href="<c:url value="/admin/hello"></c:url>" class="primary-btn text-uppercase">Get Started</a>
                                    </div>
                                    <div class="col-lg-4 col-md-6 banner-right">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <mvc:form class="form-wrap" action="${pageContext.request.contextPath}/searchFlight" method="POST" modelAttribute="searchInformation">
                                                <mvc:select path="departure"  class="form-control" id="selectplace" >
                                                    <mvc:option value="" label="From"/>
                                                    <mvc:options items="${listPlace}"/>
                                                </mvc:select>
                                                <mvc:select path="arrival"  class="form-control" id="selectplace">
                                                    <mvc:option value="" label="To"/>
                                                    <mvc:options items="${listPlace}"/>
                                                </mvc:select>
                                                ...
                                                <mvc:input path="date" type="date" class="form-control date-picker"/>
                                                <!--                                                    <input type="text" class="form-control date-picker" name="return" placeholder="Return " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Return '">-->
                                                <br>                                                          
                                                <mvc:button class="primary-btn text-uppercase">Search</mvc:button>
                                            </mvc:form>
                                        </div>
                                    </div>
                                </div>
