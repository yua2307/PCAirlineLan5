                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addAirport"/>">Add airport</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="form_container">
                            <mvc:form method="POST" action="addAirportProcess" modelAttribute="airport" id="subscribe_frm">
                                <table>
                                    <tr>
                                        <td>Nhập tên thành phố: </td>
                                        <td>
                                            <mvc:input path="cityName"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nhập tên sân bay: </td>
                                        <td>
                                            <mvc:input path="airportName"/>
                                        </td>
                                    </tr>
                                </table>
