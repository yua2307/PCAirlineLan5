                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addFlight"/>">Add flight</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<c:url value="/admin/addAdmin"/>">Add admin</a>
                            <a class="collapse-item" href="<c:url value="/admin/allAdmin"/>">List admin</a>
                            <a class="collapse-item" href="<c:url value="/admin/allCustomer"/>">List customer</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <mvc:form method="POST" action="addFlightProcess" modelAttribute="flight" id="subscribe_frm">
                            <table>
                                <tr>
                                    <td>Chọn máy bay </td>
                                    <td>
                                        <mvc:select path="aircraft">
                                            <c:forEach items="${aircraftList}" var="tempAircraft"> 
                                                <mvc:option value="${tempAircraft.getAirCraftId()}">${tempAircraft.getAircraftName()}</mvc:option>
                                            </c:forEach>
                                        </mvc:select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <mvc:select path="flightRoute">
                                            <c:forEach items="${flightRouteList}" var="tempFlightRoute"> 
                                                <mvc:option value="${tempFlightRoute.getRouteID()}">${tempFlightRoute.getDeparturePlace().getAirportName()}-${tempFlightRoute.getArrivalPlace().getAirportName()}</mvc:option>
                                            </c:forEach>
                                        </mvc:select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <mvc:input path="departureTime" type="datetime-local" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nhập giờ đến nơi: </td>
                                    <td>
                                        <mvc:input path="arrivalTime" type="datetime-local" />
                                    </td>
                                </tr><tr>
                                    <td>Nhập tổng số ghế </td>
                                    <td>
                                        <mvc:input path="seat"/>
                                    </td>
                                </tr>
                            </table>
                            <mvc:button>Add flight</mvc:button>
                        </mvc:form>
                    </div>
                    <!-- /.container-fluid -->
